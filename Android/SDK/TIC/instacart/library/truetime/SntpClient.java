...
public class SntpClient {
    ...
    private AtomicLong cachedDeviceUptime = new AtomicLong();
    private AtomicLong cachedSntpTime = new AtomicLong();
    private AtomicBoolean sntpInitialized = new AtomicBoolean(false);
