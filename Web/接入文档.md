...
<!-- WebIM SDK -->
<script src="本地im-sdk或者使用npm包"></script>
<!-- COS SDK -->
<script src="本地cos-sdk或者使用npm包"></script>
<!-- 白板SDK -->
<script src="https://tic-res-1259648581.file.myqcloud.com/board/2.4.6/TEduBoard.min.js"></script>
<!-- TIC SDK -->
<script src="https://tic-res-1259648581.file.myqcloud.com/tic/2.5.0/TIC.min.js"></script>
```
...
| 参数    | 类型    | 必填 | 说明|
|--------- | --------- | ----- | --------- |
| classId | Number | 是 | 课堂 ID，32位整型，取值范围[1, 2147483647]
...
| 参数    | 类型    | 必填 | 说明|
|--------- | --------- | ----- | --------- |
| classId | Number | 是 | 课堂 ID，32位整型，取值范围[1, 2147483647]，由业务方下发，并保证每次下发的 classId 是唯一不重复的 |
